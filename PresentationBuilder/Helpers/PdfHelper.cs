...
namespace PresentationBuilder.Helpers
{
    public class PdfHelper
    {
        ...
        {
            splitToImages(path, outputPath, "IMG_OUTPUT%03d.jpg", 20);
        }
        ...
        /// <returns></returns>
        public static void splitToImages(string path, string outputPath, string filename = "IMG_OUTPUT%03d.jpg", int multipleFilePageCount = 100)
        {
            try
            {
